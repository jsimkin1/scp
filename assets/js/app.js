var App = function () {
    ...
    var handleDashboardCharts = function () {
        ...
        function showTooltip(title, x, y, contents) {
            $('<div id="tooltip" class="chart-tooltip"><div class="date" style="font-weight:bold;">' + title + '<\/div><div>Submissions: 126<\/div><\/div>').css({
                position: 'absolute',
                display: 'none',
                top: y - 100,
                width: 120,
        ...
        var comp_data = [
            ...
            { label: "Underpriced",  data: 12, color: "#00af66"},
        ];
         
        var plot_statistics = $(document).ready(function () {
            $.plot($("#plot_competitiveness"), comp_data, {
                 series: {
                    pie: {
                        innerRadius: 0.5,
                        show: true
